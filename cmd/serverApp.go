...
func runServer(applicationConfiguration config.ApplicationConfiguration) {
...
func resolveEncodingType(configuration config.Authorization) userPorts.IEncodingService {
...
func resolveUserEndpointAuthorization(authorizationConfig config.Authorization) userPorts.IUserEndpointHandler {
...
func resolveCachingInstance(configuration config.CacheConfiguration) userPorts.IUserCache {
...
func resolvePasswordService(configuration *config.EncryptionConfiguration) userPorts.IUserPasswordService {
	return userServices.NewBcryptUserPasswordService(configuration)
}

func resolveDatabaseInstance(configuration config.DatabaseConfiguration) userPorts.IUserRepository {
